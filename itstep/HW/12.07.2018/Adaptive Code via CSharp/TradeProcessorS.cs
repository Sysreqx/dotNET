...
namespace Adaptive_Code_via_CSharp
{
    ...
    class TradeProcessorS
    {
        ...
        {
            using (var connection = new System.Data.SqlClient.SqlConnection("DataSource = (local);" +
                " Initial Catalog = TradeDatabase;" +
        ...
        public void ProcessorTrades(System.IO.Stream stream)
        {
